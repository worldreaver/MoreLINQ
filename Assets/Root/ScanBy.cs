...
namespace MoreLinq
{
    ...
    static partial class MoreEnumerable
    {
            ...
            IEqualityComparer<TKey> comparer)
        {
            ...
            IEnumerable<KeyValuePair<TKey, TState>> _(IEqualityComparer<TKey> localComparer)
            {
                var stateByKey = new Dictionary<TKey, TState>(localComparer);
                ...
                foreach (var item in source)
                {
                    ...
                    if (!(prevKey.HasValue
                       ...
                       && localComparer.GetHashCode(prevKey.Value) == localComparer.GetHashCode(key)
                       && localComparer.Equals(prevKey.Value, key)
