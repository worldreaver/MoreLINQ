...
namespace MoreLinq
{
    ...
    static partial class MoreEnumerable
    {
            ...
            IEqualityComparer<TKey> comparer)
        {
            ...
            IEnumerable<TResult> _(IEqualityComparer<TKey> localComparer)
            {
                var alookup = Lookup<TKey,TFirst>.CreateForJoin(first, firstKeySelector, localComparer);
                var blookup = Lookup<TKey, TSecond>.CreateForJoin(second, secondKeySelector, localComparer);
